...
namespace Fixi_Grid.Api
{
    public class FixiDataController : ApiController
    {
        public HttpResponseMessage GetCourtStructure()
        {
            ...
            //    new CourtStructure(){ CourtId= 7, CourtName= "Tennis Court 7", ParentCourtId= 12, ColSpan= 1, RowSpan= 2, Color= "#3333FF" },
            ...
            var courts = new List<CourtStructure>() {
                ...
                new CourtStructure(){ Type=1, CourtId= 4, CourtName= "Tennis Court 4", ParentCourtId= 9, ColSpan= 1, RowSpan= 1, Color= "#3333FF" },
                new CourtStructure(){ Type=1, CourtId= 5, CourtName= "Tennis Court 5", ParentCourtId= 9, ColSpan= 1, RowSpan= 1, Color= "#3333FF" },
